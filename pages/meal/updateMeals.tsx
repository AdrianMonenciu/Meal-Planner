              ...
              <div key={index} className={`flex justify-between items-center gap-3 py-1 md:py-2`}>
                <div className='flex items-center gap-3'>
                  ...
                  <div className={`max-h[350] text-left  max-w-[160px] md:max-w-[300px] leading-tight`}>
                    <p className="whitespace-nowrap text-xs md:text-sm font-bold truncate">{meal.privateBool ? "Private" : "Public"}</p>
                    <p className="text-left text-sm md:text-lg -mt-1 md:-mt-0 whitespace-nowrap truncate">{meal.name}</p>
                  </div>
                </div>
                ...
                <span className="h-[24px] md:h-full flex justify-end">
                  ...
                  <div className="min-w-[20px] h-full px-1 md:px-2">
                    <button onClick={() => router.push(`/meal/mealEdit/${meal.name}`)}
                  ...
                  <div className="min-w-[20px] px-1 md:px-2">
                    <button onClick={handleUserDelete(meal.name)}
