...
export const getServerSideProps: GetServerSideProps = async (context) => {
    ...
    async function getFoodItems(querryData: string[]) {
        ...
        responseLoaded.payload.weeklyPlanData.availableFoodItems = data.results
        //console.log(currentFoodItemsData)
        })
    ...
    async function getMeals(querryData: string[]) {
        ...
        const url = `/api/meal/getMealsByDiet?diets=${encodedMeals}`;
        ...
        .then(data => {
            responseLoaded.status = 'loaded' 
            responseLoaded.payload.weeklyPlanData.availableMeals = data})
        .catch(err => responseError = { status: 'error', error: "Error getting the Meals!"});
