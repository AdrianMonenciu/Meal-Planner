...
export default function UpdateFood(foodItemProps) {
  ...
  const initialValues: FormValues = {
    ...
    privateBool:
      foodItemProps.response.status == 'loaded' ? foodItemProps.response.payload.results[0].privateBool : false,
    foodMeasureUnit:
      foodItemProps.response.status == 'loaded' ? foodItemProps.response.payload.results[0].foodMeasureUnit : '',
            ...
            <div className="flex flex-col md:flex-row md:gap-x-10 gap-5">
              <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-col">
                  <div
                    className={`${styles.input_group} ${
                      formik.values.foodMeasureUnit == '' && formik.touched.name ? 'border-rose-600' : ''
                    }`}>
                    <select
                      name="dietPreference"
                ...
                <div
                  ...
                  <div className="text-left ml-3 mt-1 font-medium text-sm md:text-base" id="checkbox-group">
                    Dietary suitability:
                  </div>
              ...
              <div className="flex flex-col items-center gap-5">
                <div className={`${styles.input_group} w-full flex-col bg-green-100`}>
