...
export default function Register() {
  ...
  const [allPrivateFoodItems, setAllPrivateFoodItems] =
                ...
                >
                  ...
                  <FieldArray
                    ...
                    render={(arrayHelpers) => (
                      <div className="w-full flex flex-col ">
                        <div className="title">
                          <p className="w-3/4 ml-2 font-bold">
                            Meal ingredients 2:
                          </p>
                        </div>
                        {values.foodItems2.map((name, index) => (
                          <div
                            key={index}
                            className={`flex flex-col  w-full ${
                              index < values.foodItems2.length - 1 ? "mb-4" : ""
                            }`}
                          >
                  ...
                  <div className="min-w-[10px] mt-3 flex justify-center">
                    <button
                      type="submit"
                      className={`${styles.button} max-w-[100px] `}
                    >
                      Add Meal
                    </button>
                  </div>
