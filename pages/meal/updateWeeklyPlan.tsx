              ...
              <div key={index} className={`flex justify-between items-center gap-1 md:gap-3 py-1 md:py-2`}>
                <div className="flex justify-start items-center gap-1.5 md:gap-3 text-xs md:text-base">
                  ...
                  <div className="text-[9px] md:text-sm">
                    {generateDatesFromWkNumber(weeklyPlan.weekNr, weeklyPlan.year)}
                  </div>
                </div>
                ...
                <span className="h-[24px] md:h-full flex justify-end items-center">
                  <div className="px-1 md:px-2">
                    <button
                      onClick={() => router.push(`/meal/weeklyPlanNewFrom/${weeklyPlan._id}`)}
                  ...
                  <div
                    ...
                    <button
                      onClick={() => router.push(`/meal/weeklyPlanEdit/${weeklyPlan._id}`)}
                  ...
                  <div
                    ...
                    <button
                      onClick={() => router.push(`/meal/weeklyPlanView/${weeklyPlan._id}`)}
