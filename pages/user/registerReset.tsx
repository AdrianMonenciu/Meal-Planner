    ...
    <Layout>
      ...
      <section className="flex flex-col justify-evenly gap-10 m-auto bg-slate-50 rounded-md w-3/5 text-center py-4 px-4">
        ...
        <form className="flex flex-col gap-5" onSubmit={formik.handleSubmit}>
          ...
          <div
            className={`${styles.input_group} ${formik.errors.email && formik.touched.email ? 'border-rose-600' : ''}`}>
            <input
              type="email"
              name="email"
              placeholder="Email"
          ...
          <div
            className={`${styles.input_group} ${
              formik.values.dietPreference == '' && formik.touched.username ? 'border-rose-600' : ''
            }`}>
            <select
              name="dietPreference"
          ...
          {formik.errors.dietPreference && formik.touched.dietPreference ? (
            <span className="text-rose-500">{formik.errors.dietPreference}</span>
          ) : (
            <></>
          )}
          ...
          <div>
            {formik.values.image ? (
              <img src={previewImage} className="mt-4 object-cover" style={{ width: '440px', height: `${300}px` }} />
            ) : (
              'No Image'
            )}
          </div>
          ...
          <div className="input-button">
            <button type="submit" className={styles.button} onClick={() => formik.resetForm()}>
              Reset
            </button>
          </div>
        </form>
