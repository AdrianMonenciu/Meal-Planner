      ...
      <section className="min-w-[250px] max-w-[320px] md:max-w-[500px] items-center mx-auto flex flex-col gap-3 mt-4 md:mt-8">
        ...
        <form className="flex flex-col gap-3 md:gap-5 items-center" onSubmit={formik.handleSubmit}>
          ...
          <div className={`${styles.input_group} flex-col bg-green-100`}>
            <div
              className={`mt-2 ml-1 mb-2 w-full 
                ${
          ...
          <label
            className={`mr-3 ml-2 -mb-1 md:-mb-1.5 md:ml-3 mt-2 md:mt-3 self-start text-left text-sm md:text-base ${
              formik.values.noDiet ? 'text-gray-500' : ''
            }`}>
            <input
              className={`mr-1`}
              type="checkbox"
          ...
          <div className="flex flex-col">
            <div
              className={`${styles.input_group} ${
                formik.errors.oldPassword && formik.touched.oldPassword ? 'border-rose-600' : ''
              }`}>
              <input
...
export const getServerSideProps: GetServerSideProps<{
  ...
  return {
    props: {
      sessionObj: await unstable_getServerSession(context.req, context.res, authOptions)
    }
  };
};
