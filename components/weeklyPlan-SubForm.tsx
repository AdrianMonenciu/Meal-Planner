...
export const DailyInputFieldArray = ({
  values,
  weeklyPlanProps,
  setFieldValue,
  fieldName,
  ...
  const fieldNameUpper = fieldName
    ? fieldName.charAt(0).toUpperCase() + fieldName.slice(1).toLowerCase()
    : "";
  const fieldNameMealBreakfast = fieldName
    ? fieldName + "MealsBreakfast"
    : "MondayMeals";
  ...
  const foodItemsOptions = !values.privateAll
    ? weeklyPlanProps.response.payload.weeklyPlanData.foodItemsSelectOptions
    : weeklyPlanProps.response.payload.weeklyPlanData
        .foodItemsSelectOptionsAllPrivate;
  const foodItemsOptionsObj = !values.privateAll
    ? weeklyPlanProps.response.payload.weeklyPlanData.availableFoodItems
    : weeklyPlanProps.response.payload.weeklyPlanData
        .availableFoodItemsAllPrivate;

  const mealOptions = !values.privateAll
    ? weeklyPlanProps.response.payload.weeklyPlanData.mealsSelectOptions
    : weeklyPlanProps.response.payload.weeklyPlanData
        .mealsSelectOptionsAllPrivate;
  const mealOptionsObj = !values.privateAll
    ? weeklyPlanProps.response.payload.weeklyPlanData.availableMeals
    : weeklyPlanProps.response.payload.weeklyPlanData.availableMealsAllPrivate;
  ...
  const MealSelect = ({ setFieldValue }) => {
    ...
    function getMealOptionLabel(value) {
      const selectedOption = mealTypeOptions.find(
    ...
    function updateIdSelect(selectedOption) {
      const currentMeal = mealOptionsObj.find(
        (meal) => meal.name === selectedOption
      );
        ...
        <div className="flex flex-row items-center mt-1 mb-1 md:mt-2 md:mb-2  gap-1">
          ...
          <div className="flex flex-col gap-1 md:gap-2">
            <Select
              ...
              options={mealOptions.filter((item) => {
        ...
        <div className="flex ml-4">
          <span
            className={`text-rose-500 mr-5 text-sm md:text-base ${
              error.name || error.mealType ? "mb-1" : ""
            }`}
          >
  ...
  const FoodSelect = ({ setFieldValue }) => {
    ...
    function updateQtyOptionAndIdSelect(selectedOption) {
      const currentFoodItem = foodItemsOptionsObj.find(
    ...
    return (
      <div
        className={` flex flex-col min-h-[72px] bg-green-100 border rounded-xl`}
      >
        <div className="flex flex-row mt-1 mb-1 md:mt-2 md:mb-2 items-center ">
          ...
          <div className="flex flex-col gap-1 md:gap-2 ml-1 mr-1">
            <Select
              ...
              isSearchable={true}
              value={{ value: name, label: name }}
              options={foodItemsOptions.filter((item) => {
            ...
            <div className="gap-1 md:gap-1 flex flex-row items-center">
              <div className="w-[165px] md:w-[180px] flex flex-row justify-between items-center border rounded-lg h-8 md:h-10 bg-white text-sm md:text-base">
                <input
                  type="number"
                  name="qty"
                  className="w-[85px] md:w-[100px] rounded-lg h-full pl-2"
                  value={qty}
                  onChange={(e) => {
                ...
                />
                <div className="mr-2 flex items-center text-sm justify-center h-full">
                  {"["}
                  {qtyOption}
                  {"]"}
                </div>
        ...
        <FieldArray
          ...
          render={(arrayHelpers) => (
            <div className="w-full flex flex-col mb-1">
              ...
              {values[fieldNameMealBreakfast] &&
                values[fieldNameMealBreakfast].map((name, index) => (
                  <div
                    key={index}
                    className={`flex flex-col  w-full ${
                      index < values[fieldNameMealBreakfast].length - 1
                        ? "mb-1"
                        : "mb-1"
                    }`}
                  >
                      ...
                      <div className="w-16 h-16 ml-1 md:ml-2 flex items-center justify-center">
                        {values[fieldNameMealBreakfast][index].image ? (
                          <Image
                            ...
                            alt={
                              values[fieldNameMealBreakfast][index].image
                                ? (values[fieldNameMealBreakfast][index]
                                    .image as string)
                                : ""
                            }
                            secure
                      ...
                      <div className="flex flex-row items-center ml-1 ">
                        ...
                        <div className="min-w-[20px] mb-1 px-1 ">
                          ...
                          >
                            <FontAwesomeIcon
                              icon={faTrash}
                              className="w-4.5 h-4.5 mt-1 ml-1 mr-1 md:ml-2 md:mr-2"
                              aria-hidden="true"
                            />
                          </button>
                        </div>
              ...
              <div
                className={`text-rose-500 mr-5 text-sm md:text-base mt-0.5 md:mt-1 ml-2 mb-1`}
              >
                <ErrorMessage name={fieldNameMealBreakfast}>
                  {(errorMsg) => {
                    const hasMaxError = errorMsg.includes(
                      "Maximum 3 meals are allowed!"
                    );
        ...
        <FieldArray
          ...
          render={(arrayHelpers) => (
            <div className="w-full flex flex-col mb-1">
              ...
              {values[fieldNameMealLunch] &&
                values[fieldNameMealLunch].map((name, index) => (
                  <div
                    key={index}
                    className={`flex flex-col  w-full ${
                      index < values[fieldNameMealLunch].length - 1
                        ? "mb-1"
                        : "mb-1"
                    }`}
                  >
                      ...
                      <div className="w-16 h-16 ml-1 md:ml-2 flex items-center justify-center">
                        {values[fieldNameMealLunch][index].image ? (
                          <Image
                            ...
                            alt={
                              values[fieldNameMealLunch][index].image
                                ? (values[fieldNameMealLunch][index]
                                    .image as string)
                                : ""
                            }
                            secure
        ...
        <FieldArray
          ...
          render={(arrayHelpers) => (
            <div className="w-full flex flex-col mb-1">
              ...
              {values[fieldNameMealDinner] &&
                values[fieldNameMealDinner].map((name, index) => (
                  <div
                    key={index}
                    className={`flex flex-col  w-full ${
                      index < values[fieldNameMealDinner].length - 1
                        ? "mb-1"
                        : "mb-1"
                    }`}
                  >
                      ...
                      <div className="w-16 h-16 ml-1 md:ml-2 flex items-center justify-center">
                        {values[fieldNameMealDinner][index].image ? (
                          <Image
                            ...
                            alt={
                              values[fieldNameMealDinner][index].image
                                ? (values[fieldNameMealDinner][index]
                                    .image as string)
                                : ""
                            }
                            secure
        ...
        <FieldArray
          ...
          render={(arrayHelpers) => (
            <div className="w-full flex flex-col ">
              ...
              {values[fieldNameSnaks] &&
                values[fieldNameSnaks].map((name, index) => (
                  <div
                    key={index}
                    className={`flex flex-col justify-start w-full ${
                      index < values[fieldNameSnaks].length - 1
                        ? "mb-2 md:mb-3"
                        : "mb-0"
                    }`}
                  >
                    <div className={`flex flex-row items-center `}>
                      ...
                      <div className="flex flex-wrap ml-2 max-w-[245px] md:max-w-[275px]  gap-1 md:gap-2">
                        <div className="flex items-center overflow-hidden pl-2 w-60 mb-0.5 md:mb-0 md:w-[270px] text-sm md:text-base border rounded-lg h-8 md:h-10 bg-white">
                          <p className="text-center whitespace-nowrap truncate">
                            {values[fieldNameSnaks][index].name}
                          </p>
                        </div>
                        ...
                        <div className="flex items-center justify-between w-[159px] md:w-[180px] border rounded-lg h-8 md:h-10 bg-white text-sm md:text-base">
                          <Field
                            type="number"
                            name={`${fieldNameSnaks}.${index}.qty`}
                            className={`w-20 md:w-24 rounded-lg h-full pl-2`}
                            onChange={(e) => {
                              const value = e.target.value;
                              setFieldValue(
                                `${fieldNameSnaks}.${index}.qty`,
                                value !== "" ? Number(value) : null
                              ); // Convert to number or set to null
                            }}
                          />
                          <div className="ml-1 mr-2 flex items-center justify-center h-full">
                            {"["}
                            {values[fieldNameSnaks][index].qtyOption}
                            {"]"}
                          </div>
                        </div>
                        ...
                        <div className="min-w-[10px] ml-3 md:ml-0 mr-1 md:mr-1">
                          <button
                            ...
                            onClick={() => arrayHelpers.remove(index)}
                          >
                            <span className="ml-1 mr-1 md:ml-2 md:mr-2">
                              Remove
                            </span>
                          </button>
                        </div>
                ...
                <div className={`flex flex-row items-center `}>
                  <div className="w-16 h-16 ml-1 flex items-center justify-center">
                    {values[fieldNameSnaks][index].image ? (
                      <Image
                        ...
                        alt={
                          values[fieldNameSnaks][index].image
                            ? (values[fieldNameSnaks][index].image as string)
                            : ""
                        }
                        secure
                        dpr="auto"
                  ...
                  <div className="flex flex-col justify-end ml-2 max-w-[245px] md:max-w-[275px]  gap-1 md:gap-2">
                    ...
                    <div className="flex self-start items-center justify-between w-[159px] md:w-[180px] border rounded-lg h-8 md:h-10 bg-white text-sm md:text-base">
                      <div
                        className={`w-20 md:w-24 flex items-center rounded-lg h-full pl-2`}
                      >
                        {values[fieldNameSnaks][index].qty}
                      </div>
                      <div className="ml-1 mr-2 flex items-center justify-center h-full">
                        {"["}
                        {values[fieldNameSnaks][index].qtyOption}
