...
export const DailyInputFieldArray = ({ values, weeklyPlanProps, setFieldValue, fieldName, errors, touched }) => {
  ...
  const foodItemsOptions = !values.privateAll
    ...
    : weeklyPlanProps.response.payload.weeklyPlanData.foodItemsSelectOptionsAllPrivate;
  const foodItemsOptionsObj = !values.privateAll
    ? weeklyPlanProps.response.payload.weeklyPlanData.availableFoodItems
    : weeklyPlanProps.response.payload.weeklyPlanData.availableFoodItemsAllPrivate;

  const mealOptions = !values.privateAll
    ? weeklyPlanProps.response.payload.weeklyPlanData.mealsSelectOptions
    : weeklyPlanProps.response.payload.weeklyPlanData.mealsSelectOptionsAllPrivate;
            ...
            <div className="gap-1 flex flex-row items-center">
              ...
              <div className="min-w-[10px] mr-1 md:mr-1">
                <button
                  ...
                  onClick={() => {
                    if (name != 'Please select a meal!' && mealType != 'Meal Type') {
                      addNewField();
                      setName('Please select a meal!');
                ...
                values[fieldNameMealBreakfast].map((name, index) => (
                  <div
                    ...
                    className={`flex flex-col  w-full ${
                      index < values[fieldNameMealBreakfast].length - 1 ? 'mb-1' : 'mb-1'
                    }`}
                  >
                      ...
                      <div className="w-16 h-16 ml-1 md:ml-2 flex items-center justify-center">
                        {values[fieldNameMealBreakfast][index].image ? (
                          <Image
                            ...
                            alt={
                              values[fieldNameMealBreakfast][index].image
                                ? (values[fieldNameMealBreakfast][index].image as string)
                                : ''
                            }
                            secure
                            dpr="auto"
              ...
              {values[fieldNameMealLunch] &&
                values[fieldNameMealLunch].map((name, index) => (
                  <div
                    key={index}
                    className={`flex flex-col  w-full ${
                      index < values[fieldNameMealLunch].length - 1 ? 'mb-1' : 'mb-1'
                    }`}
                  >
                    <div className={`flex flex-row items-center `}>
                      <div className="w-16 h-16 ml-1 md:ml-2 flex items-center justify-center">
                        {values[fieldNameMealLunch][index].image ? (
                          <Image
                            ...
                            alt={
                              values[fieldNameMealLunch][index].image
                                ? (values[fieldNameMealLunch][index].image as string)
                                : ''
                            }
                            secure
                            dpr="auto"
              ...
              {values[fieldNameMealDinner] &&
                values[fieldNameMealDinner].map((name, index) => (
                  <div
                    key={index}
                    className={`flex flex-col  w-full ${
                      index < values[fieldNameMealDinner].length - 1 ? 'mb-1' : 'mb-1'
                    }`}
                  >
                    <div className={`flex flex-row items-center `}>
                      <div className="w-16 h-16 ml-1 md:ml-2 flex items-center justify-center">
                        {values[fieldNameMealDinner][index].image ? (
                          <Image
                            ...
                            alt={
                              values[fieldNameMealDinner][index].image
                                ? (values[fieldNameMealDinner][index].image as string)
                                : ''
                            }
                            secure
                            dpr="auto"
          ...
          render={arrayHelpers => (
            <div className="w-full flex flex-col ">
                ...
                values[fieldNameSnaks].map((name, index) => (
                  <div
                    ...
                    className={`flex flex-col justify-start w-full ${
                      index < values[fieldNameSnaks].length - 1 ? 'mb-2 md:mb-3' : 'mb-0'
                    }`}
                  >
                    <div className={`flex flex-row items-center `}>
                      <div className="w-16 h-16 ml-1 flex items-center justify-center">
                        {values[fieldNameSnaks][index].image ? (
                          <Image
                            ...
                            alt={
                              values[fieldNameSnaks][index].image ? (values[fieldNameSnaks][index].image as string) : ''
                            }
                            secure
                            dpr="auto"
                            quality="auto"
              ...
              <div className={`text-rose-500 mr-5 text-sm md:text-base mt-1 md:mt-2 ml-2 mb-1`}>
                <ErrorMessage name={`${fieldNameSnaks}`}>{error => <ErrorDisplay error={error} />}</ErrorMessage>
              </div>
            </div>
          )}
        />
        ...
        <div className="w-full flex flex-col mb-1">
          ...
          {values[fieldNameMealLunch] &&
            values[fieldNameMealLunch].map((name, index) => (
              <div
                key={index}
                className={`flex flex-col  w-full ${index < values[fieldNameMealLunch].length - 1 ? 'mb-1' : 'mb-1'}`}
              >
                <div className={`flex flex-row items-center `}>
                  <div className="w-16 h-16 ml-1 md:ml-2 flex items-center justify-center">
                    {values[fieldNameMealLunch][index].image ? (
        ...
        <div className="w-full flex flex-col mb-1">
          ...
          {values[fieldNameMealDinner] &&
            values[fieldNameMealDinner].map((name, index) => (
              <div
                key={index}
                className={`flex flex-col  w-full ${index < values[fieldNameMealDinner].length - 1 ? 'mb-1' : 'mb-1'}`}
              >
                <div className={`flex flex-row items-center `}>
                  <div className="w-16 h-16 ml-1 md:ml-2 flex items-center justify-center">
                    {values[fieldNameMealDinner][index].image ? (
                ...
                <div className={`flex flex-row items-center `}>
                  ...
                  <div className="flex flex-col justify-end ml-2 max-w-[245px] md:max-w-[275px]  gap-1 md:gap-2">
                    ...
                    <div className="flex self-start items-center justify-between w-[159px] md:w-[180px] border rounded-lg h-8 md:h-10 bg-white text-sm md:text-base">
                      <div className={`w-20 md:w-24 flex items-center rounded-lg h-full pl-2`}>
